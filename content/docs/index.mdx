...
Built on the [Taxonomy](https://github.com/shadcn-ui/taxonomy) app by shadcn, it integrates Next.js 14, Neon, Auth.js v5, Resend, React Email, Shadcn/ui, and Stripe.
